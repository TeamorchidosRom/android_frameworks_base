 ...
 */
public class LightningClockController implements ClockPlugin {
     ...
     */
    public LightningClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.lightning_clock, null);
    ...
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.lightning_thumbnail);
    }

    @Override
    public Bitmap getPreview(int width, int height) {

        View previewView = mLayoutInflater.inflate(R.layout.lightning_clock, null);
